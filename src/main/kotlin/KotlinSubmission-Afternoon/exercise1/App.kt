...
val groupId = "Procyon"
val groupMember = listOf("Nurafia", "Jogy Gunawan", "Evina", "Bima", "Hanan", "amelia", "Salsa", "Risa", "Nisa", "Rizky", "Chris")
...
fun totalMember(): Int {
    ...
    val countOfGroup = listOf("Nurafia", "Jogy Gunawan", "Evina", "Bima", "Hanan", "amelia", "Salsa", "Risa", "Nisa", "Rizky", "Chris")
...
fun main() {
    ...
    fun main() {
        ...
        val groupId = "Procyon"
        val groupMembers = listOf("Nurafia", "Jogy Gunawan", "Evina", "Bima", "Hanan", "amelia", "Salsa", "Risa", "Nisa", "Rizky", "Chris")
        val session = "Afternoon"
